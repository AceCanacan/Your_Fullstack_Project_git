...
const Cart = ({ cart, updateQuantity, onCheckout }) => {
  ...
  <img src={item.images[0].image} alt={item.title} style={{ width: '50px', marginRight: '10px' }} />
) : (
  <img src="placeholder-image-url" alt={item.title} style={{ width: '50px', marginRight: '10px' }} />
)}
                </td>
